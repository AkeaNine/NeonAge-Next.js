...
const page = () => {
  return (
    <div className=" flex justify-center p-6">
      ...
      <h1 className=" text-lg lg:text-2xl flex justify-center"><span className="text-green-500 mx-2"><BsEnvelopeCheckFill size={26}/></span><span>Password Reset Email Sent</span>
      ...
      <p className="text-center text-lg lg:text-xl">Thank you for using our services!</p>
    </div>
    </div>
  );
};
